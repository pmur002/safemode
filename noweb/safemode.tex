...
takes one argument: whether to print out debugging information
({\Tt{}FALSE\nwendquote} by default).  This function
...
\nwlinkedidentc{repl}{NW3fNyKO-2jP4FB-1}(sys.parent(), debug)
...
\nwlinkedidentc{repl}{NW3fNyKO-2jP4FB-1} <- function(env, debug) \{
...
{\Tt{}cmd\nwendquote} buffer.  Each time a line is added, an attempt is made to
...
\LA{}if there was an error deal with it~{\nwtagstyle{}\subpageref{NW3fNyKO-KMkqD-1}}\RA{}
\LA{}otherwise handle the expression~{\nwtagstyle{}\subpageref{NW3fNyKO-42roNn-1}}\RA{}
...
\nwenddocs{}\nwbegincode{19}\sublabel{NW3fNyKO-KMkqD-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3fNyKO-KMkqD-1}}}\moddef{if there was an error deal with it~{\nwtagstyle{}\subpageref{NW3fNyKO-KMkqD-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW3fNyKO-N1orb-1}}\nwenddeflinemarkup
if (inherits(ans, "error")) \{
    ...
    \}
\}
\nwused{\\{NW3fNyKO-N1orb-1}}\nwidentuses{\\{{\nwixident{cmd}}{cmd}}\\{{\nwixident{handleParseError}}{handleParseError}}\\{{\nwixident{incompleteParse}}{incompleteParse}}\\{{\nwixident{prompt}}{prompt}}}\nwindexuse{\nwixident{cmd}}{cmd}{NW3fNyKO-KMkqD-1}\nwindexuse{\nwixident{handleParseError}}{handleParseError}{NW3fNyKO-KMkqD-1}\nwindexuse{\nwixident{incompleteParse}}{incompleteParse}{NW3fNyKO-KMkqD-1}\nwindexuse{\nwixident{prompt}}{prompt}{NW3fNyKO-KMkqD-1}\nwendcode{}\nwbegindocs{20}\nwdocspar
...
\nwenddocs{}\nwbegincode{21}\sublabel{NW3fNyKO-42roNn-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW3fNyKO-42roNn-1}}}\moddef{otherwise handle the expression~{\nwtagstyle{}\subpageref{NW3fNyKO-42roNn-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW3fNyKO-N1orb-1}}\nwenddeflinemarkup
else \{
    ...
    \nwlinkedidentc{cmd}{NW3fNyKO-2jP4FB-1} <- character()
\}
\nwused{\\{NW3fNyKO-N1orb-1}}\nwidentuses{\\{{\nwixident{cmd}}{cmd}}\\{{\nwixident{prompt}}{prompt}}}\nwindexuse{\nwixident{cmd}}{cmd}{NW3fNyKO-42roNn-1}\nwindexuse{\nwixident{prompt}}{prompt}{NW3fNyKO-42roNn-1}\nwendcode{}\nwbegindocs{22}\nwdocspar
...
\}
\nwused{\\{NW3fNyKO-4X48TB-1}}\nwidentuses{\\{{\nwixident{cmd}}{cmd}}}\nwindexuse{\nwixident{cmd}}{cmd}{NW3fNyKO-41HQ4C-1}\nwendcode{}\nwbegindocs{34}\nwdocspar
...
\nwixlogsorted{c}{{if there was an error deal with it}{NW3fNyKO-KMkqD-1}{\nwixu{NW3fNyKO-N1orb-1}\nwixd{NW3fNyKO-KMkqD-1}}}%
...
\nwixlogsorted{c}{{otherwise handle the expression}{NW3fNyKO-42roNn-1}{\nwixu{NW3fNyKO-N1orb-1}\nwixd{NW3fNyKO-42roNn-1}}}%
